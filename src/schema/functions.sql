...
-------------------------------------------
CREATE OR REPLACE FUNCTION values_by_year_1995_2012(table_name text, value_column text, other_columns text)
RETURNS SETOF RECORD AS $$
BEGIN
    RETURN QUERY EXECUTE format(
...
-------------------------------------------
CREATE OR REPLACE FUNCTION values_by_year_1984_2014(table_name text, value_column text, other_columns text)
RETURNS SETOF RECORD AS $$
BEGIN
    RETURN QUERY EXECUTE format(
